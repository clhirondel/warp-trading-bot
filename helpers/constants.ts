...
// Read new ATA fees
export const ATA_PRIORITY_FEE_MAX_MICROLAMPORTS = Number(process.env.ATA_PRIORITY_FEE_MAX_MICROLAMPORTS || '0'); // Default to 0 if not set
// --- End New Default Fee Calculation ---
